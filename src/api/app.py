...
- Loads search/generation parameters from configs/service.yaml
- Service with a single-page UI that shows the answer and supporting paragraphs.
...
DEFAULT_CONFIG = Path("configs/service.yaml")
